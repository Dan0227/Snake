...
body_list = [(x, y)]
score_value = 0
snake_speed = 14  # Velocidad inicial de la serpiente
...
def reset_game():
    global x, y, delta_x, delta_y, food_x, food_y, body_list, game_over, score_value, game_paused, cat_mode, food_image, snake_speed
    x, y = 300, 300
    ...
    snake_speed = 14  # Reiniciar la velocidad
...
def snake():
    global x, y, food_x, food_y, game_over, score_value, game_paused, cat_mode, food_image, high_score, snake_speed
    x = (x + delta_x) % width
    y = (y + delta_y) % height
    ...
    if snake_rect.colliderect(food_rect):
        ...
        if score_value == 15:
            ...
            snake_speed = 20  # Aumentar la velocidad de la serpiente
